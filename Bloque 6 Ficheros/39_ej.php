...
<body>
    <h2>Subir archivo</h2>
    <form action="./39_ej.php" method="post" enctype="multipart/form-data">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($uploadOk == 1) {
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                // Generar un enlace para visualizar el archivo subido
                echo "<br><a href='" . basename($target_file) . "'>Ver archivo</a>";
            } else {
