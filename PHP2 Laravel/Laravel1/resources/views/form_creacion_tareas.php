    ...
    <div class="container mt-5">
        ...
        <input type="hidden" name="_token" value="<?= csrf_token(); ?>">
            <fieldset class="border p-4 rounded">
                ...
                <div class="mb-3">
                    <label for="nif_cif" class="form-label">NIF/CIF <?= mostrarErrores('nif_cif', $errores) ?></label>
                ...
                <div class="mb-3">
                    <label for="direccion" class="form-label">Dirección <?= mostrarErrores('direccion', $errores) ?></label>
                    <input type="text" class="form-control" name="direccion" id="direccion" value="<?= valorPost('direccion') ?>">
                </div>

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="poblacion" class="form-label">Población <?= mostrarErrores('poblacion', $errores) ?></label>
                        <input type="text" class="form-control" name="poblacion" id="poblacion" value="<?= valorPost('poblacion') ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="codigo_postal" class="form-label">Código Postal <?= mostrarErrores('codigo_postal', $errores) ?></label>
                        <input type="text" class="form-control" name="codigo_postal" id="codigo_postal" value="<?= valorPost('codigo_postal') ?>">
                    </div>
                </div>

                <div class="mb-3">
                    <label for="provincias" class="form-label">Provincia <?= mostrarErrores('provincia', $errores) ?></label>
                ...
                <div class="mb-3">
                    <label for="operarios" class="form-label">Operario encargado <?= mostrarErrores('operario', $errores) ?></label>
                ...
                <div class="mb-3">
                    <label for="anotaciones_anteriores" class="form-label">Anotaciones anteriores (Opcional) <?= mostrarErrores('anotaciones_anteriores', $errores) ?></label>
                ...
                <div class="mb-3">
                    <label for="anotaciones_posteriores" class="form-label">Anotaciones posteriores (Opcional)<?= mostrarErrores('anotaciones_posteriores', $errores) ?></label>
