...
<div class="container mt-5">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            {!! $utiles->mostrarErrores('telefono_contacto', $errores ?? []) !!}
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" name="fichero_resumen" id="fichero_resumen" accept=".pdf">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" name="fotos_trabajo[]" id="fotos_trabajo" accept="image/*" multiple>
