        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <!-- Menú de Navegación -->
                    <li class="nav-item">
                        <a class="nav-link {{ $utiles->myUrl('home') == url()->current() ? 'active' : '' }}" href="{{ $utiles->myUrl('home') }}">
                            <i class="fas fa-home me-1"></i> Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $utiles->myUrl('nueva-tarea') == url()->current() ? 'active' : '' }}" href="{{ $utiles->myUrl('nueva-tarea') }}">
                            <i class="fas fa-plus-circle me-1"></i> Nueva Tarea
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $utiles->myUrl('ver-tareas') == url()->current() ? 'active' : '' }}" href="{{ $utiles->myUrl('ver-tareas') }}">
