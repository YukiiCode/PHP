...
Route::post('/guardar-cliente', [ClientesController::class, 'store'])->name('clientes.store');

Route::post('/upload', [FileController::class, 'upload'])->name('upload');

// Tareas
Route::get('/nueva-tarea', [TareasController::class, 'create'])->name('tareas.create');
Route::get('/form', [TareasController::class, 'form'])->name('nueva-tarea');
Route::post('/nueva-tarea', [TareasController::class, 'store'])->name('tareas.store');
Route::get('/editar-tarea/{id}', [TareasController::class, 'edit'])->name('tareas.edit');
Route::get('/confirmar-borrado-tarea/{id}', [TareasController::class, 'index'])->name('tareas.confirm-delete');
...
Route::post('/verification/resend', [Auth\VerificationController::class, 'resend'])->name('verification.resend');
